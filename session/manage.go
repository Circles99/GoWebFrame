...
func (m *Manager) GetSession(ctx *GoWebFrame.Context) (Session, error) {
...
func (m *Manager) InitSession(ctx *GoWebFrame.Context, id string) (Session, error) {
...
func (m *Manager) RefreshSession(ctx *GoWebFrame.Context) (Session, error) {
